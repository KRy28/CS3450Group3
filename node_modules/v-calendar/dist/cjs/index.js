...
function createCalendar(props, { emit, slots }) {
  ...
  const focusableDay = vue.ref(new Date().getDate());
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.openBlock(), vue.createElementBlock("div", {
    ...
    vue.renderSlot(_ctx.$slots, "day-content", {
      ...
      vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", vue.mergeProps(_ctx.dayContentProps, vue.toHandlers(_ctx.dayContentEvents)), [
