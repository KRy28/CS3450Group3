...
function tzParseTimezone(timezoneString, date, isUtcDate) {
  ...
  if (token2) {
    ...
    absoluteOffset = hours2 * MILLISECONDS_IN_HOUR$1;
  ...
  if (token2) {
    ...
    absoluteOffset = hours2 * MILLISECONDS_IN_HOUR$1 + minutes * MILLISECONDS_IN_MINUTE$1;
    return token2[1] === "+" ? -absoluteOffset : absoluteOffset;
  }
...
function startOfWeekYear(dirtyDate, dirtyOptions) {
  ...
  var date = startOfWeek$1(firstWeek, dirtyOptions);
  return date;
}
...
function _sfc_render$4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createElementBlock("div", {
    ...
    renderSlot(_ctx.$slots, "day-content", {
      ...
      withDirectives((openBlock(), createElementBlock("div", mergeProps(_ctx.dayContentProps, toHandlers(_ctx.dayContentEvents)), [
...
function createDatePicker(props, ctx) {
  ...
  function forceUpdateValue(value, {
    ...
    if (isDisabled) {
      ...
      normalizedValue = dateValue.value;
    } else if (// Clear value if same value was passed
